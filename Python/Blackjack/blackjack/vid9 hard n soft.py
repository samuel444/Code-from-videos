...
true_hard_strategy = {
    ...
    (8, '2','N'): 'hit', (8, '3','N'): 'hit', (8, '4','N'): 'hit', (8, '5','N'): 'hit', (8, '6','N'): 'hit',
    (8, '7','N'): 'hit', (8, '8','N'): 'hit', (8, '9','N'): 'hit', (8, '10','N'): 'hit', (8, 'J','N'): 'hit', (8, 'Q','N'): 'hit', (8, 'K','N'): 'hit', (8, 'A','N'): 'hit',

    (9, '2','N'): 'hit', (9, '3','N'): 'double', (9, '4','N'): 'double', (9, '5','N'): 'double', (9, '6','N'): 'double',
    (9, '7','N'): 'hit', (9, '8','N'): 'hit', (9, '9','N'): 'hit', (9, '10','N'): 'hit', (9, 'J','N'): 'hit', (9, 'Q','N'): 'hit', (9, 'K','N'): 'hit', (9, 'A','N'): 'hit',

    (10, '2','N'): 'double', (10, '3','N'): 'double', (10, '4','N'): 'double', (10, '5','N'): 'double', (10, '6','N'): 'double',
    (10, '7','N'): 'double', (10, '8','N'): 'double', (10, '9','N'): 'double', (10, '10','N'): 'hit', (10, 'J','N'): 'hit', (10, 'Q','N'): 'hit', (10, 'K','N'): 'hit', (10, 'A','N'): 'hit',
    ...
    (12, '2','N'): 'hit', (12, '3','N'): 'hit', (12, '4','N'): 'stand', (12, '5','N'): 'stand', (12, '6','N'): 'stand',
...
true_soft_strategy = {
    ...
    (17, '2','N'): 'hit', (17, '3','N'): 'double', (17, '4','N'): 'double', (17, '5','N'): 'double', (17, '6','N'): 'double',
...
true_split_strategy = {
    ...
    (10, '2','N'): 'no', (10, '3','N'): 'no', (10, '4','N'): 'no', (10, '5','N'): 'no', (10, '6','N'): 'no',
...
def newhand(cardsLeft, money):
    global money_graph, wins, loss, betSize, count, prepared, winnings, move
    blackjack = False
    ...
    for i in range(len(prepared)):
        if prepared[i]:
            if move[i] == 'stand':
                winnings[i][0] += (money-money_initial)
                winnings[i][3] += 1
            elif move[i] == 'hit':
                winnings[i][1] += (money-money_initial)
                winnings[i][4] += 1
            elif move[i] == 'double':
                winnings[i][2] += (money-money_initial)
                winnings[i][5] += 1

    prepared = [False for i in range(len(true_soft_strategy))]
    move = ['stand' for i in range(len(true_soft_strategy))]
...
def player(cardsLeft, hand, dealer):
    ...
    while True:
        ...
        true_count = trueCount(cardsLeft)
        if true_count == truth and soft:
            location = list(true_soft_strategy).index((valuation, dealer[:-1], 'N'))
...
winnings = [[0,0,0,0,0,0] for i in range(len(true_soft_strategy))]
prepared = [False for i in range(len(true_soft_strategy))]
move = ['stand' for i in range(len(true_soft_strategy))]
truth = 6
...
for i in range(len(winnings)):
    print("For the combination " + str((list(true_soft_strategy))[i]) + ' we get:')
    if winnings[i][3] != 0 and winnings[i][4] != 0 and winnings[i][5] != 0:
        standResult = winnings[i][0]/winnings[i][3]
        hitResult = winnings[i][1]/winnings[i][4]
        doubleResult = winnings[i][2]/winnings[i][5]
        if standResult > hitResult and standResult > doubleResult:
            print('The best is to stand with £' + str(standResult) + ' being made from gathering ' + str(winnings[i][3]) + " results!")
        elif hitResult > doubleResult:
            print('The best is to hit with £' + str(standResult) + ' being made from gathering ' + str(winnings[i][4]) + " results!")
        else:
            print('The best is to double with £' + str(standResult) + ' being made from gathering ' + str(winnings[i][5]) + " results!")
    else:
        print('Invalid since there was not enough results')
    print('')
