...
def newhand(cardsLeft, money):
    ...
    if true_count >= 1:
        betsizes = [5,15,22,34,45,59,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111,111]
        bet = betsizes[true_count]
    else:
        bet = betSize
...
while rep <= repetitions: #and money > 0:
    rep += 1
    if len(cardsLeft) <= (decks * 52 * 0.3) or trueCount(cardsLeft) < -3:
        cardsLeft = reshuffle(decks)
